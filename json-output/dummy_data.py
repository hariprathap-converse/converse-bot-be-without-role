...
def insert_dummy_data():
    ...
    admin_employment_details = EmployeeEmploymentDetails(
        ...
        # Must match admin_employee.employment_id
        employee_id=admin_employee.employment_id,
    )
    ...
    teamlead_employment_details = EmployeeEmploymentDetails(
        ...
        # Must match teamlead_employee.employment_id
        employee_id=teamlead_employee.employment_id,
    )
    ...
    regular_employment_details = EmployeeEmploymentDetails(
        ...
        # Must match regular_employee.employment_id
        employee_id=regular_employee.employment_id,
    )
